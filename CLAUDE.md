...
- The Durable Object rate limiter must cover public AI, push, and every `/admin/*` route before expensive work.
- Rate-limit actor keys must remain opaque; never log raw connecting addresses or credentials.
- Durable Object failures must fall back to the capped in-isolate limiter; they must never take public chat down. Exhausted budgets return 429.
